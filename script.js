...
function Show_UpdatedProducts() {
  //this shows total no after the page reloads
  let get_ItemNumber = localStorage.getItem("ItemNumber");
...
function DisplayItems() {
  ...
  if (getproducts && store) {
    ...
    // <button onclick="openNav()" class="button1" ><a class="checkout" >Check-Out</a></button>
    // <button onclick="deleteItems()" class="button2">Empty Cart</button> `
  }
}
...
function openNav() {
  if (
    localStorage.getItem("P_details") &&
    localStorage.getItem("Amount") &&
    localStorage.getItem("ItemNumber")
  ) {
